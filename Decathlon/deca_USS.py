...
outer = './OUTPUT_PATH/'
path = './PATH/TO/DECATHLON/ADC/'
path2 = './PATH/TO/DECATHLON/T2/'
...
def run():
    ...
    for obj in os.listdir(path):
            ...
            image2 = cv2.imread(full_path2) 
            img3 = image * image2 *10
            img3[img3>255]=255
            image = img3
            ...
            seg_map = segmentation.slic(image, n_segments=3000, compactness=20, sigma=1, start_label=1)
